...
mframe_t flipper_frames_start_run[] = {ai_run, 8,      NULL, ai_run, 8,      NULL, ai_run,     8,
                                       NULL,   ai_run, 8,    NULL,   ai_run, 8,    flipper_run};
...
mframe_t flipper_frames_pain2[] = {ai_move, 0,       NULL, ai_move, 0,       NULL, ai_move, 0,
...
mframe_t flipper_frames_pain1[] = {ai_move, 0,       NULL, ai_move, 0,       NULL, ai_move, 0,
                                   NULL,    ai_move, 0,    NULL,    ai_move, 0,    NULL};
