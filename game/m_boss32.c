...
mframe_t makron_frames_pain6[] = {
    ...
    ai_move, 0, NULL,         ai_move, 0, NULL, ai_move, 0, NULL, ai_move, 0, NULL,         ai_move, 0, NULL,
    ai_move, 0, makron_popup, ai_move, 0, NULL, ai_move, 0, NULL, ai_move, 0, NULL,         ai_move, 0, NULL, // 20
    ai_move, 0, NULL,         ai_move, 0, NULL, ai_move, 0, NULL, ai_move, 0, makron_taunt, ai_move, 0, NULL,
...
mframe_t makron_frames_attack3[] = {
    ai_charge, 0, NULL, ai_charge, 0, NULL, ai_charge, 0, NULL, ai_charge, 0, makronBFG, // FIXME: BFG Attack here
    ai_move,   0, NULL, ai_move,   0, NULL, ai_move,   0, NULL, ai_move,   0, NULL};
