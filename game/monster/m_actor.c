...
char *actor_names[MAX_ACTOR_NAMES] = {"Hellrot",    "Tokay",   "Killme", "Disruptor",
...
mframe_t actor_frames_walk[] = {ai_walk, 0, NULL, ai_walk, 6, NULL, ai_walk, 10, NULL, ai_walk, 3, NULL,
...
void actor_walk(edict_t *self) { self->monsterinfo.currentmove = &actor_move_walk; }

mframe_t actor_frames_run[] = {ai_run, 4,  NULL, ai_run, 15, NULL, ai_run, 15, NULL, ai_run, 8,  NULL,
...
mframe_t actor_frames_pain1[] = {ai_move, -5, NULL, ai_move, 4, NULL, ai_move, 1, NULL};
mmove_t actor_move_pain1 = {FRAME_pain101, FRAME_pain103, actor_frames_pain1, actor_run};

mframe_t actor_frames_pain2[] = {ai_move, -4, NULL, ai_move, 4, NULL, ai_move, 0, NULL};
mmove_t actor_move_pain2 = {FRAME_pain201, FRAME_pain203, actor_frames_pain2, actor_run};

mframe_t actor_frames_pain3[] = {ai_move, -1, NULL, ai_move, 1, NULL, ai_move, 0, NULL};
mmove_t actor_move_pain3 = {FRAME_pain301, FRAME_pain303, actor_frames_pain3, actor_run};

mframe_t actor_frames_flipoff[] = {ai_turn, 0, NULL, ai_turn, 0, NULL, ai_turn, 0, NULL, ai_turn, 0, NULL,
...
mframe_t actor_frames_taunt[] = {
    ai_turn, 0, NULL, ai_turn, 0, NULL, ai_turn, 0, NULL, ai_turn, 0, NULL, ai_turn, 0, NULL, ai_turn, 0, NULL,
    ai_turn, 0, NULL, ai_turn, 0, NULL, ai_turn, 0, NULL, ai_turn, 0, NULL, ai_turn, 0, NULL, ai_turn, 0, NULL,
    ai_turn, 0, NULL, ai_turn, 0, NULL, ai_turn, 0, NULL, ai_turn, 0, NULL, ai_turn, 0, NULL};
...
void actorMachineGun(edict_t *self) {
  ...
  monster_fire_bullet(self, start, forward, 3, 4, DEFAULT_BULLET_HSPREAD, DEFAULT_BULLET_VSPREAD,
...
mframe_t actor_frames_death1[] = {ai_move, 0,       NULL, ai_move, 0,       NULL, ai_move, -13,     NULL, ai_move, 14,
                                  NULL,    ai_move, 3,    NULL,    ai_move, -2,   NULL,    ai_move, 1,    NULL};
mmove_t actor_move_death1 = {FRAME_death101, FRAME_death107, actor_frames_death1, actor_dead};

mframe_t actor_frames_death2[] = {ai_move, 0,  NULL, ai_move, 7,  NULL, ai_move, -6,  NULL, ai_move, -5,  NULL,
                                  ai_move, 1,  NULL, ai_move, 0,  NULL, ai_move, -1,  NULL, ai_move, -2,  NULL,
                                  ai_move, -1, NULL, ai_move, -9, NULL, ai_move, -13, NULL, ai_move, -13, NULL,
                                  ai_move, 0,  NULL};
...
mframe_t actor_frames_attack[] = {ai_charge, -2, actor_fire, ai_charge, -2, NULL,
                                  ai_charge, 3,  NULL,       ai_charge, 2,  NULL};
...
void target_actor_touch(edict_t *self, edict_t *other, cplane_t *plane, csurface_t *surf) {
  ...
  {
    other->enemy = G_PickTarget(self->s.cmodel_index, self->pathtarget);
    if(other->enemy) {
  ...
  other->movetarget = G_PickTarget(self->s.cmodel_index, self->target);
