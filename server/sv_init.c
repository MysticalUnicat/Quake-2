...
================
*/
void SV_SpawnServer(char *server, char *spawnpoint, server_state_t serverstate, qboolean attractloop,
                    qboolean loadgame) {
  int i;
  unsigned checksum;
  ...
  ge->SpawnEntities(sv.name, CM_EntityString(CMODEL_A), spawnpoint);
